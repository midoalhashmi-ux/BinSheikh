...
```
اختياري — فقط لو تبي ميزة "تقييمات الأفلام والمسلسلات" بلوحة التحكم
(زر "🎯 تحديث كل التقييمات"). الصق مفتاح "API Key (v3 auth)" من
themoviedb.org/settings/api. الأنمي (Jikan/MyAnimeList) لا يحتاج أي
مفتاح ويعمل بدونه تلقائياً — تخطّي هذا السر فقط يوقف تقييمات
الأفلام/المسلسلات ولا يؤثر على أي شيء آخر بالووركر.
